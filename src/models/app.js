...
import { isLogin, userName, userId, setLoginIn, setLoginOut, menu } from '../utils'
    ...
    *login({
        ...
        if(dataToken.success) {
          ...
          if (data && data.success) {
            ...
            yield setLoginIn(payload.username, dataToken.access_token, data.role_power, allPathPowers, data.id)
            yield put({
              type: 'loginSuccess',
              payload: {
                user: {
